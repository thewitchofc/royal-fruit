      ...
      <section id="vegetables-price-list" className="section sheet-products-page-section price-menu-body vegetables-section">
        <div className="container vegetables-premium-shell">
          ...
          <SheetPriceListAsMenu
            ...
            productImageOnlyPrefixes={["מיני תפוח אדמה", "מיני מלפפון", "מלפפון יפני", "מלפפון אורגני בלה מאיה", "עגבניות אורגניות בלה מאיה", "עגבניות שרי בלה מאיה", "פאקוס", "ארטישוק", "מיני גמבה", "עלי בייבי", "עלי רוקט", "עלי תרד", "נבטים סינים", "נבטים סיניים", "רוברבר", "לבבות קיסר", "קולסלאו", "עלי סלרי", "עלי מנגולד", "עגבניות מיובשות", "פטרוזיליה", "בזיליקום", "עירית", "שיבה", "מרווה", "רוזמרין", "שמיר", "למון גראס", "פלפל צ׳ילי", "צ׳ילי תאילנדי", "צ'ילי תאילנדי", "נענע", "בצל שאלוט", "בצל ירוק", "בצל ספרדי", "דלעת", "כרוב סיני", "כרוב ניצנים", "במיה", "תרד גוליבר צ׳רי", "תרד גוליבר צ'רי", "אפונת שלג צ׳רי", "אפונת שלג צ'רי", "אפונת גינה צ׳רי", "אפונת גינה צ'רי", "ג׳ינג׳ר", "ג'ינג'ר", "כורכום צ׳רי", "כורכום צ'רי", "תירס מתוק", "תירס צהוב מארז", "תירס לבן מארז", "אספרגוס", "מיקס כרובית טריו", "כרובית לבנה", "ברוקולי ג׳מבו", "ברוקולי ג'מבו", "שעועית ירוקה", "שעועית צהובה", "שעועית רחבה", "פול", "מארז פול", "קפיר ליים", "עלי קפיר ליים", "פינגר ליים", "אבוקדו מוכן לאכילה", "גוואקמולי", "גווקאמולי", "ממרח אבוקדו", "פטריות שמפיניון", "פטריות שימג׳י", "פטריות שי מג׳י", "פטריות פורטובלו", "מגה פורטובלו", "מגה פורטבלה"]}
          />
        </div>
      </section>
