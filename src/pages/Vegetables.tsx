      ...
      <section id="vegetables-price-list" className="section sheet-products-page-section price-menu-body vegetables-section">
        <div className="container vegetables-premium-shell">
          ...
          <SheetPriceListAsMenu
            ...
            productImageOnlyPrefixes={["מיני תפוח אדמה", "מיני מלפפון", "מלפפון יפני", "מיני גמבה", "עלי בייבי", "עלי רוקט", "עלי תרד", "נבטים סינים", "נבטים סיניים", "רוברבר", "לבבות קיסר", "קולסלאו", "עלי סלרי", "עלי מנגולד", "עגבניות מיובשות", "פטרוזיליה", "בזיליקום", "עירית", "שיבה", "מרווה", "רוזמרין", "שמיר", "למון גראס", "פלפל צ׳ילי", "צ׳ילי תאילנדי", "צ'ילי תאילנדי", "נענע", "בצל שאלוט", "בצל ירוק", "דלעת", "כרוב סיני", "במיה", "ג׳ינג׳ר", "ג'ינג'ר", "כורכום צ׳רי", "כורכום צ'רי", "תירס צהוב מארז", "תירס לבן מארז", "אספרגוס", "מיקס כרובית טריו", "כרובית לבנה", "שעועית ירוקה", "פטריות שמפיניון", "פטריות שימג׳י", "פטריות שי מג׳י", "פטריות פורטובלו", "מגה פורטובלו", "מגה פורטבלה"]}
          />
        </div>
      </section>
