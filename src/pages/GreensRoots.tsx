      ...
      >
        <div className="container vegetables-premium-shell">
          ...
          <SheetPriceListAsMenu
            ...
            productImageOnlyPrefixes={["מיני תפוח אדמה", "תפוח אדמה לבן", "גזר צבעוני", "זר גזר צבעוני", "נשנושי גזר מתוק", "גזר ארוז דוד משה", "שום טרי", "ארטישוק ירושלמי", "ג׳ינג׳ר טרי", "ג'ינג'ר טרי", "ג׳ינג׳ר", "ג'ינג'ר", "כורכום צ׳רי", "כורכום צ'רי", "קפיר ליים", "עלי קפיר ליים", "סלק וואקום", "עלי בייבי", "עלי רוקט", "עלי תרד", "נבטים סינים", "נבטים סיניים", "רוברבר", "לבבות קיסר", "חסה סלנובה", "קולסלאו", "עלי סלרי", "עלי מנגולד", "עלי גפן", "פטרוזיליה", "בזיליקום", "עירית", "שיבה", "מרווה", "רוזמרין", "שמיר", "למון גראס", "צ׳ילי תאילנדי", "צ'ילי תאילנדי", "נענע", "בצל שאלוט", "בצל ירוק"]}
          />
        </div>
      </section>
    </div>
