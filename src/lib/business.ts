...
export const BUSINESS_SCHEMA_DESCRIPTION =
  "Royal Fruit, פירות וירקות טריים עד הבית עם אספקה יומית ומבחר פרימיום";

/** אזור שירות, טקסט אחיד לפוטר, FAQ ותיאום ציפיות */
export const BUSINESS_AREA_SERVED =
  "אזור המרכז וגוש דן, כולל חולון והסביבה. המשלוחים והאיסוף מתואמים מול אורי, ליישוב או לאזור ספציפי כדאי לוודא בטלפון לפני ההזמנה.";
