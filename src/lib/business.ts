...
export const BUSINESS_HOURS_SUMMARY =
  "סגורים בשישי בערב. בשבת העסק סגור כל היום והלילה עד יום ראשון בבוקר. מחוץ לזה השירות רציף (24/6). איסוף עצמי מהחנות מומלץ לתאם מראש כדי שהסחורה תהיה ארוזה ומוכנה. לתיאום איסוף, משלוח או שאלה: " +
  BUSINESS_PHONE +
  " (" +
