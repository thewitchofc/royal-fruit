...
export const SITE_META_KEYWORDS =
  "Royal Fruit, רויאל פרוט, פירות פרימיום, ירקות פרימיום, משלוח פירות וירקות, פירות וירקות עד הבית, פירות טריים חולון, ירקות טריים חולון, משלוחי פירות חולון, משלוחי ירקות גוש דן, פירות וירקות ראשון לציון, פירות וירקות בת ים, פירות וירקות תל אביב";
